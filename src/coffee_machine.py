    ...
    def supplies_report(self):
        ...
        if self.water < 100:
            print(f'\n {(Fore.RED + 'Water: ' + '\033[39m')}{self.water}ml / 500ml')
             ...
             print(f'\n {(Fore.YELLOW + 'Water: ' + '\033[39m')}{self.water}ml / 500ml')
        else:
            print(f'\n {(Fore.GREEN + 'Water: ' + '\033[39m')}{self.water}ml / 500ml')

        if self.coffee_beans < 50:
            print(f'\n {(Fore.RED + 'Coffee: ' + '\033[39m')}{self.coffee_beans}g / 250g')
        elif self.coffee_beans <= 120:
             print(f'\n {(Fore.YELLOW + 'Coffee: ' + '\033[39m')}{self.coffee_beans}g / 250g')
        else:
            print(f'\n {(Fore.GREEN + 'Coffee: ' + '\033[39m')}{self.coffee_beans}g / 250g')
        
        if self.milk < 100:
            print(f'\n {(Fore.RED + 'Milk: ' + '\033[39m')} {self.milk}ml / 300ml')
        elif self.milk <= 200:
            print(f'\n {(Fore.YELLOW + 'Milk: ' + '\033[39m')} {self.milk}ml / 300ml')
        else:

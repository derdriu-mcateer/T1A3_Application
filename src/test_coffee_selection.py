...
# Testing that the integer inputted by the user will return the correct dictionary for the chosen key
...
# Testing that if the user inputs an integer out of the range 1-5 or a string then it will return a KeyError 
